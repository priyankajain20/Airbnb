"""
    - This script is used to upload the Airbnb data to AWS S3 bucket

    - It will upload all data directories to S3 to make it publicly accessible
    
    - The data is in raw form downloaded from the website and extracted on the local machine
